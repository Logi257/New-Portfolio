...
const Education = () => {
    const education = [
        ...
        },
        {
            ...
            period: "2024 - 2026",
            description: "Major in Computer Application with focus on Frontend Development"
        },
        {
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto space-y-6">
            {education.map((item, index) => (
                <div key={index} className="group relative bg-slate-800 p-8 rounded-2xl border border-slate-700/50 hover:border-cyan-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/10">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 pl-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h3 className="text-xl font-bold text-white group-hover:text-cyan-400 transition-colors">{item.degree}</h3>
